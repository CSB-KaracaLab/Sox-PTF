...
# 2) place list and dna_sox11_dyad_sim1_ref.pdb in your folder and make sure reference and models have the same chain/res ids.
# 3) split -l 999 pdb_list list
# 4) include dna_sox11_dyad_sim1_ref.pdb in the first line of each new pdblist (listaa, listab and so on)
...
grep -v dna_sox11_dyad_sim1_ref.pdb rmsd_dyad.pdb > a
mv a rmsd_dyad.pdb

# change the name of your rmsd file name "Sox11_dyad_sim1.rmsd-sorted"
sort -nk2 rmsd_dyad.pdb > Sox11_dyad_sim1.rmsd-sorted
