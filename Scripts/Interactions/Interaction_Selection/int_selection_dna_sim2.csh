...
# To run the script: ./int_selection_dna_sim2.csh
...
echo "frame_no Phe56 Met57 Arg51* Asn54* Tyr118*" > Sox11_dna_sim2.int

sed 's/\complex_md-fit_//g' temp |sed 's/\_sim2.interfacea//g' | sort -nk1 >> Sox11_dna_sim2.int
