...
# To run the script: ./int_selection_dyad_sim1.csh
...
echo "frame_no Phe56 Met57 Arg51* Asn54* Tyr118*" > Sox11_dyad_sim1.int

sed 's/\complex_dyad-fit_//g' temp |sed 's/\_sim1.interfacea//g' | sort -nk1 >> Sox11_dyad_sim1.int
