...
### References:
1. P-RMSD values are computed using Profit (Martin, A.C.R., http://www.bioinf.org.uk/software/profit/)
2. Minor groove values are calculated using 3DNA (Lu, Xiang‐Jun, and Wilma K. Olson. "3DNA: a software package for the analysis, rebuilding and visualization of three‐dimensional nucleic acid structures." Nucleic acids research 31.17 (2003): 5108-5121, https://x3dna.org .)
3. Interactions are calculated using Interfacea (Rodrigues,J., Valentine,C. and Jimenez,B. (2019) JoaoRodrigues/interfacea: first beta version of the API, https://github.com/JoaoRodrigues/interfacea .)
